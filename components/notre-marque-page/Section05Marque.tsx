  ...
  const data = [
    {
      id: 0,
      image:
        "/exterieurimmeublejardinfontainepergola-aluminium1763mm-x-1234mm72dpi.jpg",
      title: "Le mot des architectes",
      description: `Nous avons pensé Clé Blanche comme une alliance entre la matière 
        ...
        {data.map((item) => (
          ...
          >
            ...
            <div className="absolute bottom-0 w-full p-4 md:p-6 space-y-2"  data-aos="fade-up">
              ...
              <h2
                className={`lg:text-[20px] lg:text-[40px] font-bold text-white drop-shadow-lg ${fontTitle.className}`}
              >
                {item.title}
              </h2>
