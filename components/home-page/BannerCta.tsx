    ...
    >
      <div className="py-12 w-full h-full  bg-[#0000008c] transition-opacity duration-700">
        <div className="container mx-auto text-white px-5">
          <div className="flex flex-col gap-3 items-center text-center my-12 " data-aos="fade-up">
            <h2 className="text-base mt-6">
              Une nouvelle page s’écrit…
            </h2>
            <p className={`lg:text-[20px] lg:text-[40px] font-semibold text-second ${fontTitle.className}`}>
